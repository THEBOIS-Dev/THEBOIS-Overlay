...
const NAV = [
  { to: '/', label: 'Home', iconPath: '<path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>' },
  {
    ...
    label: 'Nicks',
    iconPath:
      '<path d="M21.41 11.58l-9-9A2 2 0 0 0 11 2H4a2 2 0 0 0-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58s1.05-.22 1.41-.59l7-7c.37-.36.59-.86.59-1.41s-.23-1.06-.59-1.42zM5.5 7a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>',
  },
  {
    to: '/theme',
    label: 'Theme',
  ...
  >
    ...
    <div class="drag flex items-center gap-2.5 pl-1 min-w-0 flex-1 h-full">
      ...
      <div class="flex items-baseline gap-1.5">
        <span
          class="font-extrabold tracking-widest gradient-text"
          style="font-size: 0.8rem; letter-spacing: 0.14em"
        >
          THEBOIS
        </span>
    ...
    <div class="no-drag flex items-center gap-1.5">
      ...
      <template v-if="isHome">
        <select
          :value="config.mode"
          class="select-field"
          style="height: 28px; font-size: 0.78rem; min-width: 100px"
          @change="onModeChange"
        >
        ...
        <select
          ...
          class="select-field"
          style="height: 28px; font-size: 0.78rem; min-width: 82px"
        ...
        <Transition name="drop">
          ...
          >
            ...
            >
              <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor">
                <path
                  d="M12 15.2a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4M20 4h-3.17L15 2H9L7.17 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm-8 13c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z"
                />
              </svg>
              Screenshot
            </button>
